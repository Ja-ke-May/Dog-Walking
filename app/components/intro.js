const Intro = () => {
    return (
      <div className="relative flex max-w-lg bg-white/0 rounded p-4  items-center">
        ...
        />
        <div className="ml-2 p-2 bg-black/90 text-[#B5A888] md:text-lg lg:text-xl brightness-125 rounded">
          <p className="">
            Hello! I'm Jake, and this is my boy, Jack. We love exploring the outdoors and bringing new friends on adventures. 
            <br /> 
